class toLowerCase implements Instruccion{
    ...
    ejecutar(entorno: Entorno): Object {
        ...
        if (nodo.tipo != Tipo.STRING) {
            let mensaje: MensajeError = new MensajeError("Semantico", "No se le puede aplicar toLowerCase() al tipo: " + Tipo[nodo.tipo], entorno.archivo, this.l, this.c);
